...
cd ../balance/session2-simulationen
...
Die Pfade sind aktuell absolut (`/home/claude/repo/server/dist/game`) und muessen vor dem ersten
Lauf auf die eigene Umgebung angepasst werden.
