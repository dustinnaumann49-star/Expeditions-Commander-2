...
[
  ...
  { id:"salvenjaeger", name:"Salvenjäger", img:"ships/salvenjaeger.png", lore:"Der Salvenjäger trägt ein experimentelles Zielerfassungs-Array, das mehrere schwache Ziele gleichzeitig erfasst, statt sie nacheinander abzuarbeiten. Gegen Schwärme aus Jägern verwandelt sich ein einzelner Treffer in ein ganzes Salvenfeuer.", tier:2.5, buildTime:30, maxCount:5,
    cost:{metall:800000, kristall:500000, deuterium:200000}, stats:{waffen:4000, schild:700, panzerung:260000} },
  { id:"salvenkreuzer", name:"Salvenkreuzer", img:"ships/salvenkreuzer.png", lore:"Der Salvenkreuzer ist die Weiterentwicklung des Salvenjägers für schwerere Ziele. Seine Feuerleitzentrale kann mehrere Kreuzer-Klasse-Schiffe zeitgleich anvisieren und abfeuern, was ganze Formationen binnen Sekunden auseinanderreißt.", tier:3.5, buildTime:60, maxCount:3,
    cost:{metall:2000000, kristall:1500000, deuterium:700000}, stats:{waffen:15000, schild:3200, panzerung:950000} },
  { id:"salvendreadnought", name:"Salvendreadnought", img:"ships/salvendreadnought.png", lore:"Der Salvendreadnought gilt als teuerster und seltenster je gebauter Schiffstyp. Seine Existenz wird von den meisten Werften bestritten, doch wer ihn im Gefecht gesehen hat, berichtet, wie er halbe Elite-Flotten in einer einzigen koordinierten Salve zerlegt.", tier:5.5, buildTime:120, maxCount:2,
    cost:{metall:4500000, kristall:3800000, deuterium:2000000}, stats:{waffen:20000, schild:5500, panzerung:1400000} }
];
