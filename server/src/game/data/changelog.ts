...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Damit die Liste "Eingehende Flotten" dabei nicht immer länger wird: Nachschub muss technisch als eigener Flug starten, wird nach der Ankunft aber automatisch mit der bereits vor Ort stehenden Flotte desselben Spielers zu einem Eintrag verschmolzen. Unterwegs befindliche Flüge bleiben getrennt, damit ihre Ankunftszeit stimmt.',
