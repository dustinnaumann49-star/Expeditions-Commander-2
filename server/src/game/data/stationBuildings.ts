...
export const STATION_BUILDINGS: StationBuildingDefinition[] = [
  // ===== V1 =====
  { id: 'v1_metallmine', name: 'Metallmine (V1)', tier: 1, kind: 'mine_metall',
  ...
  { id: 'v1_kristallmine', name: 'Kristallmine (V1)', tier: 1, kind: 'mine_kristall',
  ...
  { id: 'v1_deuteriummine', name: 'Deuterium-Synthetisierer (V1)', tier: 1, kind: 'mine_deuterium',
  ...
  { id: 'v1_solarkraftwerk', name: 'Solarkraftwerk (V1)', tier: 1, kind: 'energie',
  ...
  { id: 'v2_metallmine', name: 'Metallmine (V2)', tier: 2, kind: 'mine_metall',
  ...
  { id: 'v2_kristallmine', name: 'Kristallmine (V2)', tier: 2, kind: 'mine_kristall',
  ...
  { id: 'v2_deuteriummine', name: 'Deuterium-Synthetisierer (V2)', tier: 2, kind: 'mine_deuterium',
  ...
  { id: 'v2_solarkraftwerk', name: 'Solarkraftwerk (V2)', tier: 2, kind: 'energie',
  ...
  { id: 'v3_metallmine', name: 'Metallmine (V3)', tier: 3, kind: 'mine_metall',
  ...
  { id: 'v3_kristallmine', name: 'Kristallmine (V3)', tier: 3, kind: 'mine_kristall',
  ...
  { id: 'v3_deuteriummine', name: 'Deuterium-Synthetisierer (V3)', tier: 3, kind: 'mine_deuterium',
  ...
  { id: 'v3_solarkraftwerk', name: 'Solarkraftwerk (V3)', tier: 3, kind: 'energie',
