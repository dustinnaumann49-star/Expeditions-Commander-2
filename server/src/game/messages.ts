import type { PlayerState, CombatDetail, FarmDetail } from './types.js';
import type { ActionResult } from './actions.js';

export function pushMessage(state: PlayerState, type: 'kampf' | 'farm', text: string, detail: CombatDetail | FarmDetail | null = null) {
