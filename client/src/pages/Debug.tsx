...
// den 4 aktiven Piratenbasen, damit man Wirtschafts-/Angriffsverhalten ueber die Zeit beobachten
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 13, color: 'var(--text-dim)', marginBottom: 16 }}>
        Reines Beobachtungs-Werkzeug - zeigt den vollen, aktuellen Zustand der KI-Mitspieler und der 4 aktiven Piratenbasen, um ihr
